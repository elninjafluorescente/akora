...
ORDER=(_variables _typography _utilities _navigation _search-widget _booking-widget _landing _checkout _home)

{
  ...
  printf "@import url('https://fonts.googleapis.com/css2?family=Marcellus&family=Mulish:wght@400;500;600;700;800&family=Sacramento&display=swap');\n\n"
  for p in "${ORDER[@]}"; do
    printf '/* ===== %s ===== */\n' "$p"
    cat "partials/$p.css"
    printf '\n'
